 ...
 */
final class Version20240121182415 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE adr_facturation_user ADD CONSTRAINT FK_836269AFA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
